...
const baseURL = "https://api.friendli.ai/v1"

// Provider implements llm.Provider for the FriendliAI API.
type Provider struct {
	client *openaicompat.Client
}

// New creates a FriendliAI provider.
func New() *Provider {
	return &Provider{
...
func (p *Provider) Name() string { return "friendli" }
