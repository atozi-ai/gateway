...
const baseURL = "https://api.runmodelrun.com/v1"

// Provider implements llm.Provider for the ModelRun API.
type Provider struct {
	client *openaicompat.Client
}

// New creates a ModelRun provider.
func New() *Provider {
	return &Provider{
...
func (p *Provider) Name() string { return "modelrun" }
