...
const baseURL = "https://endpoints.ai.cloud.ovh.net/v1"

// Provider implements llm.Provider for the OVHCloud AI API.
type Provider struct {
	client *openaicompat.Client
}

// New creates an OVHCloud AI provider.
func New() *Provider {
	return &Provider{
...
func (p *Provider) Name() string { return "ovhcloud" }
