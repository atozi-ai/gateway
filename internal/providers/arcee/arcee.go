...
const baseURL = "https://api.arcee.ai/v1"

// Provider implements llm.Provider for the Arcee AI API.
type Provider struct {
	client *openaicompat.Client
}

// New creates an Arcee AI provider.
func New() *Provider {
	return &Provider{
...
func (p *Provider) Name() string { return "arcee" }
