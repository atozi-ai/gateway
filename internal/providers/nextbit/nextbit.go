...
const baseURL = "https://api.nextbit.ai/v1"

// Provider implements llm.Provider for the NextBit API.
type Provider struct {
	client *openaicompat.Client
}

// New creates a NextBit provider.
func New() *Provider {
	return &Provider{
...
func (p *Provider) Name() string { return "nextbit" }
