...
const baseURL = "https://api.phala.network/v1"

// Provider implements llm.Provider for the Phala Network API.
type Provider struct {
	client *openaicompat.Client
}

// New creates a Phala Network provider.
func New() *Provider {
	return &Provider{
...
func (p *Provider) Name() string { return "phala" }
