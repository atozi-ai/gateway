...
const baseURL = "https://api.hyperbolic.xyz/v1"

// Provider implements llm.Provider for the Hyperbolic API.
type Provider struct {
	client *openaicompat.Client
}

// New creates a Hyperbolic provider.
func New() *Provider {
	return &Provider{
...
func (p *Provider) Name() string { return "hyperbolic" }
