...
const baseURL = "https://api.morph.ai/v1"

// Provider implements llm.Provider for the Morph AI API.
type Provider struct {
	client *openaicompat.Client
}

// New creates a Morph AI provider.
func New() *Provider {
	return &Provider{
...
func (p *Provider) Name() string { return "morph" }
